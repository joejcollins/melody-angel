...
#This program 'breaks' on the first iteration of predictions
#and plots the result to show AI 'in action'...
#The original program creates two random blobs of points that will be the targets of the program
